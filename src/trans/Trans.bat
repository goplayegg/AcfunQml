...
QtTranser.exe -inputFile trans_zh.ts -outputFile trans_it.ts -targetLang it
QtTranser.exe -inputFile trans_zh.ts -outputFile trans_ja.ts -targetLang ja
QtTranser.exe -inputFile trans_zh.ts -outputFile trans_ko.ts -targetLang ko
